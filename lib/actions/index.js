...
export const GET_STREAK_FOR_GOALS = 'GET_STREAK_FOR_GOALS'
...
export function addGoalEntry (obj) {
  return dispatch => {
    return initPromise
      ...
      .then(() => dispatch(getAllEntriesForSingleDay(obj.entryDate)))
      .catch(console.log)
  }
}
...
export function getAllEntriesForSingleDay (dayTimestamp) {
  return dispatch => {
    return initPromise
      .then(function () { return habitStorage.getAllEntriesForSingleDay(dayTimestamp) })
...
export function getStreakForGoals (dayTimestamp, goals) {
  return dispatch => {
    return initPromise
      .then(function () { return habitStorage.getStreakForGoals(dayTimestamp, goals) })
      .then(json => dispatch(_getStreakForGoals(json)))
      .catch(console.log)
  }
}

export function _getStreakForGoals (obj) {
  return { type: GET_STREAK_FOR_GOALS, obj }
}
