...
class MainListView extends Component {
  ...
  constructor (props) {
    console.log('MainListView constructor')
    super()
...
MainListView.propTypes = {
  habits: React.PropTypes.arrayOf(React.Proptypes.object).isRequired,
  navigator: React.PropTypes.shape({
    push: React.PropTypes.function.isRequired
  })
}
